...
# one of the types db,file,s3
QUERY_RESULTS_STORAGE_TYPE = os.environ.get("QUERY_RESULTS_STORAGE_TYPE", "db")
# used when QUERY_RESULTS_STORAGE_TYPE = "file"
QUERY_RESULTS_STORAGE_FILE_DIR = os.environ.get("QUERY_RESULTS_STORAGE_FILE_DIR", "/app/query_result_data")
# used when QUERY_RESULTS_STORAGE_TYPE = "s3"
# QUERY_RESULTS_STORAGE_S3_BUCKET = os.environ.get("QUERY_RESULTS_STORAGE_S3_BUCKET", "")
# QUERY_RESULTS_STORAGE_S3_ACCESS_KEY_ID = os.environ.get("QUERY_RESULTS_STORAGE_S3_ACCESS_KEY_ID", "")
# QUERY_RESULTS_STORAGE_S3_SECRET_ACCESS_KEY = os.environ.get("QUERY_RESULTS_STORAGE_S3_SECRET_ACCESS_KEY", "")
